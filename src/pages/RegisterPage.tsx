...
const ROLES = [
  {
    ...
    icon: "❤️",
    desc: "Find and support causes near me",
  },
  {
    value: "charity",
    label: "I'm a charity",
    icon: "🏛",
    desc: "List our needs and receive donations",
  },
];
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        ...
        try {
          ...
          toast.success(
            `Location filled: ${city || "Unknown"}, ${state || "Unknown"}`,
          );
        } catch {
              ...
              <button
                ...
                className={`p-3 rounded-xl border-2 text-left transition-all ${
                  role === r.value
                    ...
                    : "border-border hover:border-saffron-200"
                }`}
              >
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-11 bg-background border border-border rounded-xl text-sm"
            />
            <button
              type="button"
        ...
        <div>
          <div className="flex justify-between mb-1.5">
            ...
            <button
              ...
              className="flex items-center gap-1 text-xs text-saffron-600 hover:underline font-medium"
            >
          ...
          <div className="grid grid-cols-2 gap-2">
            <input
              ...
              className="px-3 py-3 bg-background border border-border rounded-xl text-sm"
            />
            <input
              type="text"
              placeholder="State"
