...
export default function LoginPage() {
  ...
  return (
    <div>
      <h2 className="font-display font-bold text-3xl text-foreground mb-1">Welcome back</h2>
      <p className="text-muted-foreground text-sm mb-8">Sign in to your AADHAR account</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex justify-between mb-1.5">
            ...
            <a href="#" className="text-xs text-saffron-600 hover:underline font-medium">Forgot password?</a>
          </div>
        ...
        <div className="space-y-1.5 text-xs text-muted-foreground">
          {[
            ...
            <button key={role} type="button"
              ...
              <span>{email}</span>
              <span className="ml-auto text-muted-foreground/60">click to fill</span>
            </button>
          ))}
        </div>
      </div>
